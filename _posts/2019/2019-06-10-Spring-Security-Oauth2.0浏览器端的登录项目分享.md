...
tags:
 - 后端开发
description: CitySecurity项目为正式上线项目做得一个Demo,这里主要介绍浏览器端的登录.本项目使用了SpringSecurity实现表单安全登录、图形验证的校验、记住我时长控制机制、第三方登录.比较独特的一点是集合SpringSocial做第三方登录的支持...
---
...
![V6vRTe.png](https://s2.ax1x.com/2019/06/10/V6vRTe.png)
...
![V6v4fA.gif](https://s2.ax1x.com/2019/06/10/V6v4fA.gif)
